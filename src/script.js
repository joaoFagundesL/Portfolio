...
function help() {
  const commands = [
    // Here are all the commands I need
    ...
    {
      name: "cowsay",
      description: "→ here is an advice/quote, im sure you will like it",
    },
  ];
...
function socials() {
  const socials = [
    ...
    {
      name: "Linkedin",
      link: "https://www.linkedin.com/in/joao-fagundes-5b6657222/",
    },
  ];
...
function education() {
  const education = [
    ...
    },
    {
      ...
      description: "Reis Vergara Idiomas",
      time: "2019 ~ present",
    },
  ];
